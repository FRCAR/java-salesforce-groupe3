...
public class Referentiel {
    private static Roucoul roucoul1 = new Roucoul(Integer.valueOf((int)(Math.random()*150)),"monRoucoul","Roucoul",EnumType.VOL,90);
    private static Carapuce carapuce1 = new Carapuce(Integer.valueOf((int) (Math.random() * 150)), "monCarapuce", "Carapuce",
                EnumType.EAU, 100);
    private static Salameche salameche1 = new Salameche(Integer.valueOf((int) (Math.random() * 150)), "monSalameche", "Salameche",
                EnumType.FEU, 100);
    private static Racaillou racaillou1 = new Racaillou(Integer.valueOf((int) (Math.random() * 150)), "monRacaillou", "Racaillou",
                EnumType.SOL, 110);
    ...
    public void RecupAllPoke(Map<Double, String> map) {
        map.put(salameche1.getPokeId(), salameche1.getSurnom() + ". Mon espece est " + salameche1.getEspece() + ". Mon type est " +
         salameche1.getType() + ". Mon XP est de " + salameche1.getPointsXp() + ". Mes points de vies max sont de " + salameche1.getPointsDeVieMax() 
